 function eligiable() {
    ...
    var prate1 = (P1 * r1 * Math.pow((1 + r1), n1)) / (Math.pow((1 + r1), n1) - 1); // to calculate compound interest..
    ...
    var prate2 = (incomereq * r1 * Math.pow((1 + r1), n1)) / (Math.pow((1 + r1), n1) - 1); // to calculate compound interest2..
    ...
    // to assign value in field1 as fixed upto two decimal..    
     if (incomereq > P1) {
         document.formval3.field13.value = ("You are Eligible for this loan of");
         document.formval3.field11.value = (("K" + P1 + " at a forthnighly repayable amount of " + "K" + emi1.toFixed(0)));
