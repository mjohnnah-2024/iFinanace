    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-7 col-md-12 col-sm-12 col-12 text-right">
                <div class="top-nav"> <span class="top-text"><a href="https://maps.app.goo.gl/RoioD87nJKb62fnq9" target="_blank" class="text-black">Find Our Location</a> </span> <span class="top-text"><a href="/" class="text-black">+675-311-2200</a></span> </div>
            </div>
        </div>
    </div>
</div>
