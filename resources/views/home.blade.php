<x-layout>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 clearfix ">
                    <div class="testimonial-block mb30">
                        ...
                        <div class="testimonial-autor-box">
                            <div class="testimonial-img pull-left"> <img src="images/testimonial-img.jpg" alt="iFinance - Loan Company Website Template"> </div>
    ...
    <div class="section-space40 bg-white">
        <div class="container">
            <div class="row">
                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-4 col-6"> <img src="images/logo-1.jpg" alt="iFinance - Loan Company Website Template"> </div>
                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-4 col-6"> <img src="images/logo-2.jpg" alt="iFinance - Loan Company Website Template"> </div>
                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-4 col-6"> <img src="images/logo-3.jpg" alt="iFinance - Loan Company Website Template"> </div>
                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-4 col-6"> <img src="images/logo-4.jpg" alt="iFinance - Loan Company Website Template"> </div>
                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-4 col-6"> <img src="images/logo-5.jpg" alt="iFinance - Loan Company Website Template"> </div>
                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-4 col-6"> <img src="images/logo-1.jpg" alt="iFinance - Loan Company Website Template"> </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                 ...
                 <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="post-block mb30">
                        <div class="post-img">
                            <a href="blog-single.html" class="imghover"><img src="images/blog-img-1.jpg" alt="iFinance - Loan Company Website Template" class="img-fluid"></a>
                        </div>
                        <div class="bg-white pinside40 outline">
