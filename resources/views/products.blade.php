                                ...
                                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12 nopadding">
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="overview">
                                            <h1>Personal Loan</h1>
                                            <p>i-Finance offer Personal Loans to its customers working in the Public Sector and Private Sector to cover their short-term borrowing needs. </h3>
                                            <p>i-Finance Personal Loans start from K500 and repayment terms can start from 3 fortnights up to a longer term. Our customers can look at our Loan Calculator to check eligibility and choose an amount that suits them. Our interest rates are competitive and reasonable. <p>
                                            ...
                                            <p>For those working in the Public Sector, our Deduction Code under the Alesco Payroll system is DJAYF. Therefore, all public servants are eligible for a Personal Loan with i-Finance. </p>
                                                    ...
                                                    <li class="list-group-item">
                                                        <div class="row">
                                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                                <h4>Types of fees</h4></div>
                                                            <div class="col-lg-6">
                                                                <h4>Charges applicable</h4></div>
                                                        </div>
                                                    </li>
                                                    <li class="list-group-item">
                                                        <div class="row">
